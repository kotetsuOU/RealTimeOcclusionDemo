...
public class NewRsPointCloudRenderer : MonoBehaviour
{
    ...
    public ComputeBuffer GetGpuFilteredVerticesBuffer() => _compute?.GetFilteredVerticesBuffer();
    public int FinalVertexCount => _finalVertexCount;
    ...
    public Vector3 GlobalThresholdMin
    {
        get
        {
            return rsDeviceController.FrameWidth * new Vector3(1,1,1); // 仮の値
        }
    }

    public Vector3 GlobalThresholdMax
    {
        get
        {
            // 実際の実装に合わせてください
            // return _compute.GlobalThresholdMax;
            return new Vector3(5f, 2f, 5f); // 仮の値
        }
    }
}